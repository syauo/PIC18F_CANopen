...
*******************************************************************************/
   ...
   //??CO_OD 中的条目是排序的（从最低到最高索引，然后是子索引），则启用此宏??
   //这对于更长的对象字典搜索要快得多??
   //若没有排序，则禁用此宏??
...
// * 对于一些宏，在 CO_OD.c / CO_OD.h 中只写入??1 ??8 个条目??
...
/*******************************************************************************
   Default values for object dictionary 对象字典缺省??
*******************************************************************************/
...
/*        接收 PDO 映射        */
   ...
   //DD - 数据位长必须字节对齐??*），最大值为 0x40 ??8 字节 64 ??
